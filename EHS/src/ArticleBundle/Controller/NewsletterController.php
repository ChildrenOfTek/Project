...
class NewsletterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $newsletters = $em->getRepository('ArticleBundle:Newsletter')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ArticleBundle\Form\NewsletterType', $newsletter);
    ...
    {
        $deleteForm = $this->createDeleteForm($newsletter);
        $editForm = $this->createForm('ArticleBundle\Form\NewsletterType', $newsletter);
