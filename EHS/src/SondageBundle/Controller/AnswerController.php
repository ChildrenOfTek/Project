...
use SondageBundle\Entity\Answer;
use SondageBundle\Form\AnswerType;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $answers = $em->getRepository('SondageBundle:Answer')->findAll();
    ...
    {
        $deleteForm = $this->createDeleteForm($answer);
        $editForm = $this->createForm('SondageBundle\Form\AnswerType', $answer);
